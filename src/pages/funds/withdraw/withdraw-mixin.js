...
export default {
  ...
  methods: {
    ...
    async withdraw(type) {
      ...
      let res = await this.withdrawCreate(params)
      this.showDialog = false
      if (res && res.data && res.data.withdrawCreate && res.data.withdrawCreate.result) {
        this.confirmMailShow = true
        this.withdrawId = res.data.withdrawCreate.result.id
