<template>
  <div class="sliderWrapperBox">
    ...
    <div>
      <ul class="newsWrapper">
        <li class="newsSection">
          <a class="videoButton"
             href="javascript:;">
            <img src="../../assets/newImg/images/home/1_security-token.jpg" />
          </a>
        </li>
        <li class="newsSection">
          <a class="videoButton"
             href="javascript:;">
            <img src="../../assets/newImg/images/home/2_house.png" />
          </a>
          <!-- <div class="news">
            <img src="../../assets/newImg/images/home/2_house.jpg" />
            <div class="newsText">
              <h3>{{$t('m.newHome.markets')}}</h3>
              <p>{{$t('m.newHome.ownership')}}</p>
            </div>
            <a class="newsLink" href="javascript:;">{{$t('m.newHome.join')}}</a>
            <div class="blueHover"></div>
          </div> -->
        </li>
        <li class="newsSection">
          <div class="news">
            <img src="../../assets/newImg/images/home/3_bitcoin.jpg" />
            <div class="newsText">
              <h3>Bitcoin Latest News</h3>
              <!-- <h3>{{$t('m.newHome.etf')}}</h3>
              <p>{{$t('m.newHome.first')}}</p> -->
            </div>
            <!-- <a class="newsLink" href="javascript:;">{{$t('m.newHome.more')}}</a> -->
            <!-- <div class="blueHover"></div> -->
          </div>
        </li>
        <li class="newsSection">
          <div>
            <div class="wrapper">
              <div class="newsBlock">
                <div class="newsTexts">
                  <h4>{{$t('m.newHome.release')}}</h4>
                  <p>{{$t('m.newHome.jan15')}}</p>
                  <p>{{$t('m.newHome.sector')}}</p>
                </div>
                <a class="newsLink"
                   href="javascript:;">{{$t('m.newHome.view')}}</a>
              </div>
              <div class="newsBlock">
                <div class="newsTexts">
                  <h4>{{$t('m.newHome.announcement')}}</h4>
                  <p>{{$t('m.newHome.jan19')}}</p>
                  <p>{{$t('m.newHome.results')}}</p>
                </div>
                <a class="newsLink"
                   href="javascript:;">{{$t('m.newHome.view')}}</a>
              </div>
        ...
        <li class="newsSection">
          <a href="javascript:;">
            <img src="../../assets/newImg/images/home/4_shareholder.jpg" />
          </a>
        </li>
        <li class="newsSection">
          <div class="news">
            <img src="../../assets/newImg/images/home/5_trading.jpg" />
            <div class="newsText">
              <h3>{{$t('m.newHome.trading')}}</h3>
              <p>
                {{$t('m.newHome.potential')}}
              </p>
            </div>
            <a class="newsLink"
               href="javascript:;">{{$t('m.newHome.platform')}}</a>
            <!-- <div class="blueHover"></div> -->
          </div>
        </li>
      </ul>
    ...
    <div class="registerWrapper"
         v-show="!currentUser">
      <h3>{{$t('m.newHome.most')}}</h3>
      <router-link :to="$i18nRoute({path:'/signup'})">{{$t('m.menu.join')}}</router-link>
    </div>
      ...
      homeContentSlides: [
        {
          ...
          link: '#',
          background: require('../../assets/newImg/images/home/bg-1.jpg'),
          image: {
            src: require('../../assets/newImg/images/home/slide-1.jpg'),
            alt: 'Bitcoin',
          },
          boll: true,
          name: this.$t('m.newHome.easy'),
          value: this.$t('m.newHome.cash'),
        },
        {
          id: 1,
          title: 'title-access',
          ...
          boll: false,
          name: this.$t('m.newHome.opportunities'),
          value: this.$t('m.newHome.securities'),
        },
        {
          id: 2,
          title: 'title-luxury',
          ...
          boll: false,
          name: this.$t('m.newHome.estate'),
          value: this.$t('m.newHome.just'),
        },
        {
          id: 3,
          title: 'title-invest',
          subTitle: 'subtitle-structured',
          link: '#',
          ...
          boll: false,
          name: this.$t('m.newHome.private'),
          value: this.$t('m.newHome.investors'),
        },
      ],
      sliderBottom: [
        {
          title: this.$t('m.newHome.easy'),
          value: this.$t('m.newHome.cash'),
          boll: true,
        },
        {
          title: this.$t('m.newHome.opportunities'),
          value: this.$t('m.newHome.securities'),
          boll: false,
        },
        {
          title: this.$t('m.newHome.estate'),
          value: this.$t('m.newHome.just'),
          boll: false,
        },
        {
          title: this.$t('m.newHome.private'),
          value: this.$t('m.newHome.investors'),
          boll: false,
        },
      ],
