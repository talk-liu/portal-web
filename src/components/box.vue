<template>
  <div class="box-wrap"
       :class="{noshadow: showClose,fixed: isFixed}"
       :style="{height:height+'px','min-height': minHeight+'px',width:width+'px'}">
...
<script>
export default {
  props: ['title', 'showClose', 'height', 'isFixed', 'active', 'minHeight', 'width'],
  methods: {
    closeDialog() {
      this.$emit('close')
    },
