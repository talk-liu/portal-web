...
export default {
  ...
  computed: {
    ...
    circumferenceProgress() {
      return this.completedSteps >= 92 && this.completedSteps < 100 ? 149 : Math.PI * this.innerCircleDiameter
    },
    stepSize() {
    ...
    innerCircleStyle() {
      return {
        ...
        height: `${this.innerCircleDiameter}px`,
        boxShadow: `${this.circleBoxShadow}`
      }
    },
  },
  methods: {
